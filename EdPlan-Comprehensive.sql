...
--Comprehensive
select A.PERSON_ID 
,case SR_ACADEMIC_PLANS.ABBREVIATED_COMPREHENSIVE when 2 then 3 else SR_ACADEMIC_PLANS.ABBREVIATED_COMPREHENSIVE end as ABBREVIATED_COMPREHENSIVE
...
where SR_ACADEMIC_PLANS.ABBREVIATED_COMPREHENSIVE = 3 
