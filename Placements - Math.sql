...
SR_COURSE_VERSIONS.COURSE_DISCIPLINE_NBR as MATH_P,
SR_COURSE_VERSIONS.COURSE_DIGITS as MATH_DIGITS
from  SR_STUDENT_TERMS 
inner join
	(select PERSON_ID, MAX(SCORE_ID) as SCORE_ID from SR_STUDENT_SCORES A 
	inner join SR_TESTS B on A.TEST_ID = B.TEST_ID 
	where B.PLACEMENT_TYPE = 2 --in (30, 43, 44, 45, 46, 47, 50) math
